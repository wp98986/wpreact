...
function legacyRenderSubtreeIntoContainer(
  parentComponent: ?React$Component<any, any>,
  children: ReactNodeList, // 要挂载的节点
  container: Container, // 要挂载截节点的容器
  ...
  let root: FiberRoot;
  if (!maybeRoot) {
    //! 3、执行这个方法，从container节点（应用挂载的根节点）创建root
    //! 里面会将update 加入更新队列，并开启更新
    // Initial mount
...
export function render(
  ...
  //! 1、 ReactDom.render()方法的入口，首屏渲染进入这个方法
  if (__DEV__) {
    console.error(
