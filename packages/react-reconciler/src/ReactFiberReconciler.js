...
export function updateContainer(
  element: ReactNodeList, // children节点
  ...
  //! update.payload 就是要更新挂载的数据，在这里就是挂载children节点，ReactDom.render()的第一个参数
  ...
  //! 将update 加入当前fiber的updateQueue 更新队列
